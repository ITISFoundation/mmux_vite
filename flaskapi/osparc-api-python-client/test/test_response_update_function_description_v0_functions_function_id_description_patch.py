...
class TestResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch(unittest.TestCase):
    """ResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch:
        """Test ResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch`
        """
        model = ResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch()
        if include_optional:
            return ResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch(
    ...
    def testResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch(self):
        """Test ResponseUpdateFunctionDescriptionV0FunctionsFunctionIdDescriptionPatch"""
