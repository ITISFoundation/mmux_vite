...
class TestRegisteredSolverFunction(unittest.TestCase):
    """RegisteredSolverFunction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisteredSolverFunction:
        """Test RegisteredSolverFunction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisteredSolverFunction`
        """
        model = RegisteredSolverFunction()
        if include_optional:
    ...
    def testRegisteredSolverFunction(self):
        """Test RegisteredSolverFunction"""
