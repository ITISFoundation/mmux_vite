...
class TestErrorGet(unittest.TestCase):
    """ErrorGet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorGet:
        """Test ErrorGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorGet`
        """
        model = ErrorGet()
        if include_optional:
            return ErrorGet(
