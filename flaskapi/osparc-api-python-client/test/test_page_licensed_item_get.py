...
class TestPageLicensedItemGet(unittest.TestCase):
    """PageLicensedItemGet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageLicensedItemGet:
        """Test PageLicensedItemGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageLicensedItemGet`
        """
        model = PageLicensedItemGet()
        if include_optional:
            return PageLicensedItemGet(
                items = [
                    osparc_client.models.licensed_item_get.LicensedItemGet(
                        licensed_item_id = '', 
                        key = '', 
    ...
    def testPageLicensedItemGet(self):
        """Test PageLicensedItemGet"""
