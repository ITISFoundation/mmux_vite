...
class TestResponseGetFunctionV0FunctionsFunctionIdGet(unittest.TestCase):
    """ResponseGetFunctionV0FunctionsFunctionIdGet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseGetFunctionV0FunctionsFunctionIdGet:
        """Test ResponseGetFunctionV0FunctionsFunctionIdGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseGetFunctionV0FunctionsFunctionIdGet`
        """
        model = ResponseGetFunctionV0FunctionsFunctionIdGet()
        if include_optional:
            return ResponseGetFunctionV0FunctionsFunctionIdGet(
    ...
    def testResponseGetFunctionV0FunctionsFunctionIdGet(self):
        """Test ResponseGetFunctionV0FunctionsFunctionIdGet"""
