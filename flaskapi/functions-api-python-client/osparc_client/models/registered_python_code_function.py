...
class RegisteredPythonCodeFunction(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "input_schema": InputSchema.from_dict(obj["input_schema"]) if obj.get("input_schema") is not None else None,
            "output_schema": OutputSchema.from_dict(obj["output_schema"]) if obj.get("output_schema") is not None else None,
