...
class TestInputSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InputSchema:
        """Test InputSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputSchema`
        """
        model = InputSchema()
        if include_optional:
            return InputSchema(
