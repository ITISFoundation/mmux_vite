...
class TestSolverFunction(unittest.TestCase):
    """SolverFunction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SolverFunction:
        """Test SolverFunction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SolverFunction`
        """
        model = SolverFunction()
        if include_optional:
