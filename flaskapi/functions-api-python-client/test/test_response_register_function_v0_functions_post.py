...
class TestResponseRegisterFunctionV0FunctionsPost(unittest.TestCase):
    """ResponseRegisterFunctionV0FunctionsPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseRegisterFunctionV0FunctionsPost:
        """Test ResponseRegisterFunctionV0FunctionsPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseRegisterFunctionV0FunctionsPost`
        """
        model = ResponseRegisterFunctionV0FunctionsPost()
        if include_optional:
            return ResponseRegisterFunctionV0FunctionsPost(
    ...
    def testResponseRegisterFunctionV0FunctionsPost(self):
        """Test ResponseRegisterFunctionV0FunctionsPost"""
