...
class DataPreprocessor:
    ...
    def setup_log_scaling(
        ...
        Args:
            input_log_scales: List of input vars to log-transform
            output_log_scales: List of output vars to log-transform
        """
        ...
        _logger.info(
            f"Configured log scaling for {len(input_log_scales)} input and {len(output_log_scales)} output variables"
        )
