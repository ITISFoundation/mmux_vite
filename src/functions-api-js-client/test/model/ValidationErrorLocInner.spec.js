...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerFunctionsStoreOpenApi30.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new SwaggerFunctionsStoreOpenApi30.ValidationErrorLocInner();
      //expect(instance).to.be.a(SwaggerFunctionsStoreOpenApi30.ValidationErrorLocInner);
    });
