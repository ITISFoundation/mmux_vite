...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerFunctionsStoreOpenApi30.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new SwaggerFunctionsStoreOpenApi30.HTTPValidationError();
      //expect(instance).to.be.a(SwaggerFunctionsStoreOpenApi30.HTTPValidationError);
    });
