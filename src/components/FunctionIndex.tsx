    ...
    return (
        <Table
            ...
            sx={{
                ...
                '& th, & td': { color: '#eee', borderColor: '#eee' },
                '& th': { fontWeight: 'bold' },
            }}
        >
            <TableHead>
            ...
            <TableBody>
                {functions.map(fun => (
                    <TableRow
                        key={fun.id}
                        sx={{ fontWeight: fun.id === context?.selectedFunction?.id ? 'bold' : 'normal', backgroundColor: fun.id === context?.selectedFunction?.id ? '#343839' : 'inherit' }}
                    >
