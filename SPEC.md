...
B23|2026-08-28|#560 Incorrect locator scoping for `qoi-select` in e2e tests (`sumo-readonly` and `sumo-qoi-reload`) prevented validation, as `qoi-select` was correctly moved to the `Header` (outside the validation view) in the SuMo plot workflow|V13
