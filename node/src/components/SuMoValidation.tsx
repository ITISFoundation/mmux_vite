            ...
            >
              ...
              >
                <Box mt={2} display={"flex"} flexDirection={"row"} width={"100%"}>
                  {cvMetrics ? (
                    <ul style={{
                      listStyle: "none", padding: 0, margin: "0px", display: "flex", flexDirection: "row", alignContent: "center", justifyContent: "space-between", width: "100%" // Ensure the ul takes full width
                    }}>
                      <Typography
                        variant="body1"
                        fontFamily={"inherit"}
