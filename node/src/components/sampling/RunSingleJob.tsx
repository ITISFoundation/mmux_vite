...
async function runTestJob(selectedFunction: Function | undefined, context: MMUXContextType, config: SingleJobConfig[]) {
...
const TestJob = () => {
  ...
  const { singleJobConfig, setSingleJobConfig } = context;
  ...
  const handleRunSampling = async () => {
    ...
    const job = await runTestJob(selectedFunction, context, jobInputs);
