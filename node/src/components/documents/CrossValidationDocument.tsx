...
const CrossValidationDocument = (
  <Card sx={{ padding: "8px", borderRadius: "16px", maxWidth: "800px" }}>
    <CardContent sx={{ display: "flex", flexDirection: "column", alignItems: "left" }}>
      <Header headerType="subTitle" tabTitle="Cross-Validation" infoText="" />
      ...
      <Typography variant="body1" fontFamily="inherit" flex={1} mb={1}>
        Subsequently, for the ground truth values (‘Observations’) from each group, are compared to predictions obtained by
        fitting a surrogate model to the other four groups.
      </Typography>
      <Typography variant="body1" fontFamily="inherit" flex={1} mb={1}>
      ...
      <Typography variant="body1" fontFamily="inherit" sx={{ marginTop: "16px" }}>
        For additional information on the cross-validation procedure, please refer to the {getManualLink()}.
      </Typography>
    </CardContent>
  </Card>
);
