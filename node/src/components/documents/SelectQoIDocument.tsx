...
const SelectQoIDocument = (
  <Card sx={{ padding: "8px", borderRadius: "16px", maxWidth: "800px" }}>
    <CardContent sx={{ display: "flex", flexDirection: "column", alignItems: "left" }}>
      ...
      <Typography variant="body1" fontFamily="inherit" flex={1} mb={1}>
        To ensure reliable results, multiple runs of stochastic sampling assess whether the propagated uncertainty distribution
        has converged. The final uncertainty quantification accounts for two sources of uncertainty: the variability between
