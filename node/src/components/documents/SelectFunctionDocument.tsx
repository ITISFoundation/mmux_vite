  ...
  <Card sx={{ padding: "8px", borderRadius: "16px", maxWidth: "800px" }}>
    ...
    >
      ...
      <Typography variant="body1" fontFamily={"inherit"} flex={1}>
        Functions are created from parameterized pipelines using the 'Create
        Function' tab when clicking on a Project on the Dashboard
      </Typography>
      <img
      ...
      />
      <Typography variant="body1" fontFamily={"inherit"} flex={1}>
        These functions encapsulate your entire simulation workflow with
        adjustable parameters, allowing you to systematically explore how
        parameter variations affect your simulation results. The function serves
        as the foundation for uncertainty quantification by defining which
        parameters can be varied and how your simulation responds to those
        variations.
      </Typography>
      <Typography
        variant="body1"
