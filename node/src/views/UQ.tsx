...
export default function UQ() {
  ...
  const [uqSettingsModal, setUQSettingsModal] = useState<boolean>(false);
  ...
  return (
    <MetaModelingUX headerType="title" tabTitle={`Uncertainty Quantification: ${selectedFunction?.title}`}>
      <UQPlotsSteps
        ...
        onOpenSettings={() => setUQSettingsModal(true)}
        qoiSelector={
          <>
      ...
      <UQSettingsModal open={uqSettingsModal} setOpen={setUQSettingsModal} />
      <JobSampling
        loading={loading}
