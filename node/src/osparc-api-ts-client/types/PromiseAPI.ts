...
export class PromiseFilesApi {
  ...
  public abortMultipartUploadWithHttpInfo(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.abortMultipartUploadWithHttpInfo(
      fileId,
  ...
  public completeMultipartUploadWithHttpInfo(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.completeMultipartUploadWithHttpInfo(
      fileId,
  ...
  public completeMultipartUpload(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.completeMultipartUpload(
      fileId,
      bodyCompleteMultipartUploadV0FilesFileIdCompletePost,
      observableOptions,
    );
...
export class PromiseProgramsApi {
  ...
  public createProgramJobWithHttpInfo(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.createProgramJobWithHttpInfo(
      programKey,
      version,
  ...
  public createProgramJob(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.createProgramJob(
      programKey,
      version,
      xSimcoreParentProjectUuid,
      xSimcoreParentNodeId,
...
export class PromiseSolversApi {
  ...
  public createSolverJobWithHttpInfo(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.createSolverJobWithHttpInfo(
      solverKey,
      version,
      jobInputs,
      hidden,
  ...
  public createSolverJob(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.createSolverJob(
      solverKey,
      version,
      jobInputs,
      hidden,
...
export class PromiseStudiesApi {
  ...
  public createStudyJobWithHttpInfo(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.createStudyJobWithHttpInfo(
      studyId,
      jobInputs,
      hidden,
      xSimcoreParentProjectUuid,
  ...
  public createStudyJob(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.createStudyJob(
      studyId,
      jobInputs,
      hidden,
      xSimcoreParentProjectUuid,
...
export class PromiseWalletsApi {
  ...
  public checkoutLicensedItemWithHttpInfo(
    ...
    const observableOptions = wrapOptions(_options);
    const result = this.api.checkoutLicensedItemWithHttpInfo(
      walletId,
      licensedItemId,
