...
export class FunctionJobsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async deleteFunctionJob(functionJobId: string, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/function_jobs/{function_job_id}".replace(
      "{" + "function_job_id" + "}",
      encodeURIComponent(String(functionJobId)),
    );
  ...
  public async functionJobOutputs(functionJobId: string, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/function_jobs/{function_job_id}/outputs".replace(
      "{" + "function_job_id" + "}",
      encodeURIComponent(String(functionJobId)),
    );
  ...
  public async functionJobStatus(functionJobId: string, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/function_jobs/{function_job_id}/status".replace(
      "{" + "function_job_id" + "}",
      encodeURIComponent(String(functionJobId)),
    );
  ...
  public async registerFunctionJob(functionJob: FunctionJob, _options?: Configuration): Promise<RequestContext> {
    ...
    const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(functionJob, "FunctionJob", ""), contentType);
...
export class FunctionJobsApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async getFunctionJobWithHttpInfo(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async listFunctionJobsWithHttpInfo(
    response: ResponseContext,
  ): Promise<
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async registerFunctionJobWithHttpInfo(
    response: ResponseContext,
