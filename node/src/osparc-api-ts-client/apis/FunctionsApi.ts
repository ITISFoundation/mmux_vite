...
export class FunctionsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async deleteFunction(functionId: string, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}".replace("{" + "function_id" + "}", encodeURIComponent(String(functionId)));
  ...
  public async getFunctionInputschema(functionId: string, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}/input_schema".replace(
      "{" + "function_id" + "}",
  ...
  public async getFunctionOutputschema(functionId: string, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}/output_schema".replace(
      "{" + "function_id" + "}",
      encodeURIComponent(String(functionId)),
    );
   ...
   */
  public async listFunctionJobsForFunctionid(
    functionId: string,
    limit?: number,
    offset?: number,
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}/jobs".replace(
      "{" + "function_id" + "}",
      encodeURIComponent(String(functionId)),
    );
  ...
  public async mapFunction(
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}:map".replace(
      "{" + "function_id" + "}",
      encodeURIComponent(String(functionId)),
    );
  ...
  public async registerFunction(_function: Function, _options?: Configuration): Promise<RequestContext> {
    ...
    const contentType = ObjectSerializer.getPreferredMediaType(["application/json"]);
    requestContext.setHeaderParam("Content-Type", contentType);
    const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(_function, "Function", ""), contentType);
    requestContext.setBody(serializedBody);
  ...
  public async runFunction(functionId: string, body: any, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}:run".replace(
      "{" + "function_id" + "}",
      encodeURIComponent(String(functionId)),
    );
   ...
   * @param description
   */
  public async updateFunctionDescription(
    functionId: string,
    description: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}/description".replace(
      "{" + "function_id" + "}",
      encodeURIComponent(String(functionId)),
    );
  ...
  public async updateFunctionTitle(functionId: string, title: string, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}/title".replace(
      "{" + "function_id" + "}",
      encodeURIComponent(String(functionId)),
    );
  ...
  public async validateFunctionInputs(functionId: string, body: any, _options?: Configuration): Promise<RequestContext> {
    ...
    // Path Params
    const localVarPath = "/v0/functions/{function_id}:validate_inputs".replace(
      "{" + "function_id" + "}",
      encodeURIComponent(String(functionId)),
    );
...
export class FunctionsApiResponseProcessor {
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async getFunctionWithHttpInfo(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async listFunctionJobsForFunctionidWithHttpInfo(
    response: ResponseContext,
  ): Promise<
  ...
  > {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: PageAnnotatedUnionRegisteredProjectFunctionJobRegisteredPythonCodeFunctionJobRegisteredSolverFunctionJobFieldInfoAnnotationNoneTypeRequiredTrueDiscriminatorFunctionClass =
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async listFunctionsWithHttpInfo(
    response: ResponseContext,
  ): Promise<
  ...
  > {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: PageAnnotatedUnionRegisteredProjectFunctionRegisteredPythonCodeFunctionRegisteredSolverFunctionFieldInfoAnnotationNoneTypeRequiredTrueDiscriminatorFunctionClass =
        ObjectSerializer.deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async registerFunctionWithHttpInfo(
    response: ResponseContext,
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async runFunctionWithHttpInfo(
    response: ResponseContext,
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async updateFunctionDescriptionWithHttpInfo(
    response: ResponseContext,
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async updateFunctionTitleWithHttpInfo(
    response: ResponseContext,
