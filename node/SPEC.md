...
T17|x|fix B17 (#475): preserve `aria-labelledby`/`aria-describedby` on the shared `ValidationModal` replacement for `SuMoModal`, matching the other codebase modals|V22,B17
